...
create table if not exists macro_snapshots (id bigserial primary key, created_at timestamptz not null default now(), updated_at timestamptz not null default now(), source text not null, as_of_date date not null, payload_json jsonb not null);
